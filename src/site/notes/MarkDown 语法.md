---
{"dg-publish":true,"permalink":"/MarkDown 语法/","tags":["#Markdown","#Obsidian"],"noteIcon":"","created":"2024-01-02T14:09:40.646+08:00","updated":"2024-01-02T14:11:01.329+08:00"}
---
...
如果你有一定的MD语法基础，可以直接[[MarkDown 语法#19 避免标识符的滥用\|点击跳转]]
...
|                  表头1                  |                        表头2                        |
|:---------------------------------------:|:---------------------------------------------------:|
| [[MarkDown 语法#例2 表格内 单元格中的竖杠\|单元格中的竖杠]] | [[MarkDown 语法#例3 不会变成代码的反引号\|不会变成代码的反引号]] |
```
...
使用 转义符号`\` 让 反引号`` ` `` 变成普通字符，不再具有[[MarkDown 语法#7 1 行内代码\|行内代码]]的标识符功能
